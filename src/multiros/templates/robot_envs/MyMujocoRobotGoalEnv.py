...
but you need to
    ...
    2. init a node - rospy.init_node('test_MyMujocoRobotGoalEnv')
"""
register(
    id='MyMujocoRobotGoalEnv-v0',
    entry_point='multiros.templates.robot_envs.MyMujocoRobotGoalEnv:MyMujocoRobotGoalEnv',
    max_episode_steps=1000,
)


class MyMujocoRobotGoalEnv(MujocoGoalEnv.MujocoGoalEnv):
    """
    ...
    def __init__(self, ros_port: Optional[str] = None,
        ...
        if not self.real_time:
            ...
            mujoco_core.unpause_mujoco(server_name=self.server_name)
        rospy.loginfo("End Init MyMujocoRobotGoalEnv")
